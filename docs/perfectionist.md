...
Если проект уже содержит задачи, нажатие на его название в таблице переносит **Заказчика** на собственную страницу проекта. На ней все файлы, добавленные в проект, представлены в таблице заданий, а также присутствует возможность добавлений новых заданий с помощью кнопки **Create Task** (Создать задание).
