...
Если выбран вид задания **Translation** (Перевод), то поле **Your Input** (Ваш вариант) в сегментах тестового файла будет пустым, и испытуемый должен будет заполнять его. Если выбран вид задания **Editing** (Редактура), поле будет содержать текст для редактуры.
