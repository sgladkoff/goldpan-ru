...
В качестве рецензентов можно привлекать штатных и сторонних экспертов.

Результаты экспертизы качества оформляются и выгружаются в форме отчетов. 
...
Для корпоративных пользователей функциональные возможности сервиса могут быть доработаны по запросу.
