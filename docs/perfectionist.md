...
Переход на рабочую страницу задания доступен по нажатию на имя задания в списке на странице проекта.
...
Нажатие на название задания, уже назначенного **Рецензенту**, открывает страницу с двумя вкладками: **Status** (Статус) и **Results** (Результаты).
...
Если задание выполнено полностью, **Заказчик** завершает его нажатием на кнопку **Finish Review** (Завершить оценку) справа снизу.
...
**Рабочая область** задания открывается нажатием на его название в таблице заданий. Она содержит таблицу для рецензирования со столбцами **Source** (Исходный текст), **Target** (Перевод), **Errors** (Ошибки), **Fixed Target** (Исправленный перевод) и флажком **Reviewed** (Оценено), который выставляется при вносе ошибки либо вручную.
...
Появится всплывающее окно **Error Annotation, Suggestion and Comments** (Аннотация ошибки, предложение и комментарий), в котором можно ввести правильный вариант перевода сегмента (с помощью поля **Fixed Target** (Исправленный перевод)) или добавить комментарий (с помощью поля **Comment**). При этом необходимо выбрать категорию ошибки (**Category**) и ее значимость (**Severity**).
...
Переход на страницу проекта осуществляется нажатием на его название в списке. В проекте **Наблюдателям** видны только те задания, которые уже были назначены **Рецензентам**.
