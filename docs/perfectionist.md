...
Нажатие на название проекта, в который еще не были добавлены задачи, открывает окно **New Job** (Новые задачи). Кнопка **Create** (Создать) вызывает дополнительное окно, в которое можно перетащить двуязычные файлы подходящего формата; нажатие на пространство этого окна также открывает стандартный диалог поиска файлов Explorer.
