# Interpretisto: платформа видеоконференций и синхронного перевода
...
2. Для подключения к конференции откройте в браузере присланную вам ссылку Interpretisto.
...
Для работы в Interpretisto **переводчик** также должен предварительно зарегистрироваться в облаке **Logrus Global Localization Cloud** (https://accounts.logrusglobal.com/?returnUrl=https://cloud.logrusglobal.com). Для регистрации **переводчиков** создатель конференции может обратиться к администраторам Облака.
...
## Советы по работе с Interpretisto
...
Для уточнения причин задержек выполните следующую диагностику и отправьте результаты в техподдержку **Interpretisto**:
